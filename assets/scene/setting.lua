...
scene.widgetList={
    ...
    WIDGET.new{name='portrait',   type='switch', pos={1,0},x=-100,y=310, text=LANG'setting_portrait',   widthLimit=360,disp=TABLE.func_getVal(SETTINGS,'portrait'),    code=function() SETTINGS.portrait = not SETTINGS.portrait; saveSettings(); if TASK.lock('warnMessage',6.26) then MSG.new('warn',Text.setting_needRestart,6.26) end end},
