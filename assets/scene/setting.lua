...
scene.widgetList={
    WIDGET.new{type='slider_fill',x=200, y=150,w=420,h=35,text=LANG'setting_mainVol',     widthLimit=160,disp=SETval('mainVol'),       code=function(v) SETTING.mainVol=v love.audio.setVolume(SETTING.mainVol) end},
    WIDGET.new{type='slider_fill',x=200, y=200,w=420,h=35,text=LANG'setting_bgm',         widthLimit=160,disp=SETval('bgm'),           code=function(v) SETTING.bgm=v BGM.setVol(SETTING.bgm) end},
    WIDGET.new{type='slider_fill',x=200, y=250,w=420,h=35,text=LANG'setting_sfx',         widthLimit=160,disp=SETval('sfx'),           code=function(v) SETTING.sfx=v SFX.setVol(SETTING.sfx) end},
    WIDGET.new{type='slider_fill',x=200, y=300,w=420,h=35,text=LANG'setting_stereo',      widthLimit=160,disp=SETval('stereo'),        code=function(v) SETTING.stereo=v SFX.setStereo(SETTING.stereo) end,visibleFunc=function() return SETTING.sfx>0 end},
    WIDGET.new{type='slider_fill',x=200, y=350,w=420,h=35,text=LANG'setting_bgAlpha',     widthLimit=160,disp=SETval('bgAlpha'),       code=SETsto('bgAlpha')},
