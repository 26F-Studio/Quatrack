...
scene.widgetList={
    ...
    WIDGET.newSlider{name='bgAlpha',    x=200, y=350,w=420,lim=160,axis={0,.6,.01},smooth=true,  disp=SETval('bgAlpha'),code=SETsto('bgAlpha')},

    WIDGET.newSlider{name='musicDelay', x=200, y=450,w=420,lim=160,axis={-260,260,1},smooth=true,disp=SETval('musicDelay'),show=sliderShow_time,code=function(v) SETTING.musicDelay=v;_updateSFXvol() end},
    WIDGET.newSlider{name='dropSpeed',  x=200, y=500,w=420,lim=160,axis={-8,8,1},                disp=SETval('dropSpeed'),code=SETsto('dropSpeed')},
    WIDGET.newSlider{name='noteThick',  x=200, y=600,w=420,lim=160,axis={10,50,4},               disp=SETval('noteThick'),code=SETsto('noteThick')},
    WIDGET.newSlider{name='chordAlpha', x=200, y=650,w=420,lim=160,axis={0,1,.01},smooth=true,   disp=SETval('chordAlpha'),code=SETsto('chordAlpha')},
    WIDGET.newSlider{name='holdAlpha',  x=200, y=700,w=420,lim=160,axis={.2,.8},                 disp=SETval('holdAlpha'),code=SETsto('holdAlpha')},
    WIDGET.newSlider{name='holdWidth',  x=200, y=750,w=420,lim=160,axis={.2,.8},                 disp=SETval('holdWidth'),code=SETsto('holdWidth')},
    WIDGET.newSlider{name='scaleX',     x=200, y=800,w=420,lim=160,axis={.8,1.5},                disp=SETval('scaleX'),show=sliderShow_scale,code=SETsto('scaleX')},
    WIDGET.newSlider{name='trackW',     x=200, y=850,w=420,lim=160,axis={.8,1.5},                disp=SETval('trackW'),show=sliderShow_scale,code=SETsto('trackW')},
    WIDGET.newSlider{name='safeX',      x=200, y=950,w=420,lim=160,axis={0,120,10},              disp=SETval('safeX'),code=function(v) SETTING.safeX=v boundaryDispTime=2.6 end},
    WIDGET.newSlider{name='safeY',      x=200, y=1000,w=210,lim=160,axis={0,60,10},              disp=SETval('safeY'),code=function(v) SETTING.safeY=v boundaryDispTime=2.6 end},
    WIDGET.newSlider{name='showHitLV',  x=200, y=1050,w=260,lim=160,axis={1,5,1},                disp=SETval('showHitLV'),show=sliderShow_hitLV,code=SETsto('showHitLV')},
    WIDGET.newSlider{name='dvtCount',   x=200, y=1100,w=420,lim=160,axis={5,50,5},               disp=SETval('dvtCount'),code=SETsto('dvtCount')},
